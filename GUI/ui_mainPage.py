...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 569, 567))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 569, 592))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 554, 567))
...
"}")
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 569, 483))
        self.page_2.setObjectName("page_2")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.page_2)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.groupBox_Yolo = QtWidgets.QGroupBox(self.page_2)
        self.groupBox_Yolo.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.groupBox_Yolo.setFont(font)
        self.groupBox_Yolo.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.groupBox_Yolo.setTitle("")
        self.groupBox_Yolo.setObjectName("groupBox_Yolo")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.groupBox_Yolo)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.frame_7 = QtWidgets.QFrame(self.groupBox_Yolo)
        ...
        self.label_YOLO_Confidence_Treshold = QtWidgets.QLabel(self.frame_27)
        self.label_YOLO_Confidence_Treshold.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.label_YOLO_Confidence_Treshold.setStyleSheet("")
        self.label_YOLO_Confidence_Treshold.setObjectName("label_YOLO_Confidence_Treshold")
        self.formLayout_21.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_YOLO_Confidence_Treshold)
        self.horizontalSlider_YOLO_Confidence_Treshold = QtWidgets.QSlider(self.frame_27)
        self.horizontalSlider_YOLO_Confidence_Treshold.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.horizontalSlider_YOLO_Confidence_Treshold.setMaximum(100)
        self.horizontalSlider_YOLO_Confidence_Treshold.setPageStep(1)
        self.horizontalSlider_YOLO_Confidence_Treshold.setProperty("value", 50)
        self.horizontalSlider_YOLO_Confidence_Treshold.setSliderPosition(50)
        self.horizontalSlider_YOLO_Confidence_Treshold.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_YOLO_Confidence_Treshold.setObjectName("horizontalSlider_YOLO_Confidence_Treshold")
        self.formLayout_21.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.horizontalSlider_YOLO_Confidence_Treshold)
        ...
        self.formLayout_23 = QtWidgets.QFormLayout(self.frame_29)
        self.formLayout_23.setContentsMargins(0, 0, 0, 0)
        self.formLayout_23.setSpacing(10)
        self.formLayout_23.setObjectName("formLayout_23")
        self.label_24 = QtWidgets.QLabel(self.frame_29)
        self.label_24.setStyleSheet("")
        self.label_24.setObjectName("label_24")
        self.formLayout_23.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.label_24)
        self.label_YOLO_Box_Treshold = QtWidgets.QLabel(self.frame_29)
        self.label_YOLO_Box_Treshold.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.label_YOLO_Box_Treshold.setStyleSheet("")
        self.label_YOLO_Box_Treshold.setObjectName("label_YOLO_Box_Treshold")
        self.formLayout_23.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_YOLO_Box_Treshold)
        self.horizontalSlider_YOLO_Box_Treshold = QtWidgets.QSlider(self.frame_29)
        self.horizontalSlider_YOLO_Box_Treshold.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.horizontalSlider_YOLO_Box_Treshold.setMaximum(100)
        self.horizontalSlider_YOLO_Box_Treshold.setPageStep(1)
        self.horizontalSlider_YOLO_Box_Treshold.setProperty("value", 20)
        self.horizontalSlider_YOLO_Box_Treshold.setSliderPosition(20)
        self.horizontalSlider_YOLO_Box_Treshold.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_YOLO_Box_Treshold.setObjectName("horizontalSlider_YOLO_Box_Treshold")
        self.formLayout_23.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.horizontalSlider_YOLO_Box_Treshold)
...
"}")
        ...
        self.verticalLayout_6.addWidget(self.groupBox_Yolo, 0, QtCore.Qt.AlignTop)
...
"border-bottom-left-radius: 10;")
    ...
    def retranslateUi(self, MainPage):
        ...
        self.label_23.setText(_translate("MainPage", "Confidence Treshold"))
        self.label_YOLO_Confidence_Treshold.setText(_translate("MainPage", "50%"))
        self.label_24.setText(_translate("MainPage", "Box Treshold"))
        self.label_YOLO_Box_Treshold.setText(_translate("MainPage", "20%"))
